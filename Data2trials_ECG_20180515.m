function Data2trials_ECG_20180515()
...
switch ExtractionPeriod
    ...
    case 'HBC_Period'
        for indTrials =13: size(data_tr.trial,2)
...
if addToExistingTable == 1
  ...
  load( [path_save, 'HPT_CertaintyScale_Concatenated_since1309.mat']);
  AllData_Combined         = [DataOneFile; AllData_Combined];
  save([path_save, 'HPT_CertaintyScale_Concatenated_since1309' ],'AllData_Combined');
...
%% Finally, transform the mat-file to a txt-file   
    FileName = 'HPT_CertaintyScale_Concatenated_13092018.txt';
